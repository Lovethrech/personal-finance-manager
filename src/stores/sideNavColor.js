...
export const useSideNavColorStore = defineStore('sideNavColor', () => {
    ...
    const sideNavClick=()=>{
        ...
        else if((((dashboardActive.value.backgroundColor)==="#000000") || ((inventoryActive.value.backgroundColor)==="#000000") || ((orderActive.value.backgroundColor)==="#000000") || ((reportingActive.value.backgroundColor)==="#000000") || ((supportActive.value.backgroundColor)==="#000000") || ((settingActive.value.backgroundColor)==="#000000")) && ((purchaseActive.value.backgroundColor)==="#93200B")){
            dashboardActive.value.backgroundColor="#93200B";
            dashboardActive.value.borderRadius="0";
            inventoryActive.value.backgroundColor="#93200B";
            inventoryActive.value.borderRadius="0";
